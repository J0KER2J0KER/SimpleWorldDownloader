...
# Commands
The /swd saveWorldTo command has to be executed before saving the world.

/swd help<br>
Shows a list of all commands.

/swd saveWorldTo \<World Name><br>
Set the name for the saved world. If a world with this name already exists, the new chunks overwrite parts of that world. Reset it with /swd default.
